    ...
    <section class="con">
      ...
      <div class="mainCon">
        ...
        <div class="previewWrap">
          <!--放大镜效果-->
          <Zoom :skuImageUrl="skuInfo.skuDefaultImg" />
          <!-- 小图列表 -->
...
export default {
  ...
  methods: {
    ...
    async addshopCar() {
      let res =  await this.$store.dispatch("addorUpdataShopCart", {
        skuId: this.$route.params.skuid,
        skuNum: this.skuNum,
      });
      sessionStorage.setItem("skuInfo",JSON.stringify(this.skuInfo))
      this.$router.push({name:'addCartSuccess',query:{skuNum:this.skuNum},params:{skuInfo:this.skuInfo}})
    },
  },
};
</script>
